# use the camera live video as a output from CameraCapture.py and use Morphological operations to blank the page
...
for c in cnts:
    ...
    # unpack the ordered bounding box, then compute the midpoint between the top-left and top-right coordinates, followed by the midpoint between the top-right and bottom-right coordinates
    (tl, tr, br, bl) = box
